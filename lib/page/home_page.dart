...
import 'package:vega0400/data/category_model.dart';
import 'package:vega0400/data/plant_data.dart';
import 'package:vega0400/page/details_page.dart';
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: AssetImage('assets/images/paleta.jpeg'),
              ),
            ),
          ),
        ],
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: white,
                      border: Border.all(color: Color(0xff88daff)),
                      boxShadow: [
                        BoxShadow(
                          color: lightGreen.withOpacity(0.2),
                          blurRadius: 10,
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              color:
                                  selectId == i ? pink : black.withOpacity(0.7),
                              fontSize: 16.0,
                            ),
                          ),
                          if (selectId == i)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Color(0x1aff35bd), width: 2),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              top: 8,
              child: CircleAvatar(
                backgroundColor: Color(0xff1e9d4f),
                radius: 8,
                child: Image.asset(
                  'assets/icons/add.png',
                  color: white,
